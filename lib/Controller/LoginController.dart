...
class LoginController extends StatefulWidget {
  ...
  LoginControllerSate createState() => new LoginControllerSate();

}

class LoginControllerSate extends State<LoginController> {
      ...
      if (_password != null) {
        if (_log == true) {
          ...
          if (_prenom != null) {
            ...
            //Alerte prénom
            alerte("Veuillez entrer votre prénom");
          }
        }
      } else {
        //Alerte password
        alerte("Veuillez entrer un mot de passe");
      }

    } else {
      //Alerte Mail
      alerte("Veuillez entrer une adresse mail");
    }
  }
